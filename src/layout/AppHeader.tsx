    ...
    useEffect(() => {
        async function getKeywords() {
            try {
                ...
                setKeywords([
                    {
                        label: "Başka bir hesaba giriş yap",
                        path: "/giris-yap",
                        onClick: () => {
                    ...
                    {
                        label: "Destek için iletişime geç",
                        onClick: () => {
                            window.open(
                    ...
                    {
                        label: "Notları görüntüle",
                        path: "/notlar",
                    },
                    {
                        label: "Yeni not ekle",
                        path: "/notlar/not-ekle",
                    },
                    {
                        label: "Tavkim etkinliklerini görüntüle",
                        path: "/takvim",
                    },
                    userType === "Admin"
                        ? {
                              label: "Departmantları görüntüle",
                              path: "/departmanlar",
                          }
                        : null,
                    userType === "Admin"
